...
// //       // Upload thumbnail -> get URL
// //       let coverImageUrl;
// //       if (thumbFile) {
// //         const up = await api.uploadEBookImage(thumbFile);
// //         coverImageUrl =
// //           up?.data?.url || up?.data?.Location || up?.data?.secure_url || up?.data;
// //         if (!coverImageUrl) throw new Error("Upload succeeded but no URL returned");
// //       }
...
// //             padding: 24px 16px 40px; /* no extra bottom padding now */
// //             display:block;
// //           }
...
// //           }
// //           .input:hover, .file:hover{ border-color: #d1d5db; }
// //           .input:focus{
// //             border-color: #818cf8;
...
// //           }
// //           .thumb-wrap:hover{ border-color:#9ca3af; transform: translateY(-1px); }
// //           .thumb-img{
...
// //           /* NORMAL (non-fixed) Create button that scrolls with the page */
// //           .actions{
// //             max-width: 920px;
// //             margin: 16px auto 0;
// //             display:flex;
...
// //             letter-spacing:.2px;
// //             cursor: pointer;
// //             background: #4748ac; /* your brand color */
...
// //               <input className="file" type="file" accept="image/*" onChange={onPickFile} />
// //               {thumbPreview ? (
// //                 <div className="thumb-wrap" style={{ marginTop: 10, padding: 10 }}>
// //                   <img src={thumbPreview} alt="Thumbnail preview" className="thumb-img" />
// //                 </div>
// //               ) : (
// //                 <div className="thumb-wrap" style={{ marginTop: 10 }}>
// //                   <div>
// //                     No image chosen<br />
// //                     <span style={{ fontSize: 12, opacity: .9 }}>
// //                       (Optional) A compelling cover improves engagement.
// //                     </span>
// //                   </div>
// //                 </div>
// //               )}
// //               <div className="help" style={{ marginTop: 8 }}>
// //                 We’ll upload your image to S3 and save the returned URL as <code>coverImage</code>.
// //               </div>
// //             </div>
// //           </div>
// //         </div>
...
//           .input:hover, .file:hover, .textarea:hover{ border-color: #d1d5db; }
...
//               <textarea
//                 className="textarea"
//                 placeholder="A short description about this e-book..."
//                 value={description}
//                 onChange={(e) => setDescription(e.target.value)}
//               />
//               <div className="help">Shown in listings and helps learners understand the book.</div>
//             </div>
...
export default function Title() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // ✅ NEW: log backend payload (will include {code, details} from our server)
      /* eslint-disable no-console */
      console.log("[Create EBook] upload/create error payload:", err?.response?.data);

      // ✅ NEW: prefer backend 'details' if present; then 'error'; then message
      const msg =
