...
//         console.log("📘 [EBOOK] published list:", published);
//         setItems(published);
//       } catch (e) {
//         setErr(e?.response?.data?.error || e.message || "Failed to load");
//       } finally {
...
//       console.log("📘 [EBOOK] raw enrollments:", list);
...
//       console.log("📘 [EBOOK] enrolledMap final:", map);
//       setEnrolledMap(map);
//     } catch (err) {
//       console.error("❌ Failed to fetch ebook enrollments", err);
//     }
//   };
...
//   const openIntro = (e, ebookid) => {
//     if (e && e.preventDefault) e.preventDefault();
//     console.log("📘 [EBOOK] openIntro:", ebookid);
//     setPendingEbookId(ebookid);
//     setShowIntro(true);
//   };
...
//   const startReading = () => {
//     if (!pendingEbookId) return;
//     console.log("📘 [EBOOK] startReading:", pendingEbookId);
//     setShowIntro(false);
...
//         {items.map((e) => {
//           const ebookId = e.ebookid || e.id;

//           const isPaid =
//             e.isPaid === true ||
//             (typeof e.price === "number" && e.price > 0);

//           const isEnrolled = enrolledMap[ebookId] === true;

//           console.log("📘 [EBOOK CARD]", {
//             ebookId,
//             title: e.title,
//             isPaid,
//             isEnrolled,
...
//               <div
//                 onClick={
//                   isEnrolled ? (evt) => openIntro(evt, ebookId) : undefined
//                 }
...
//                   />
//                 ) : (
//                   <div className="h-44 bg-indigo-50 grid place-items-center">
//                     E-Book
//                   </div>
//                 )}
//               </div>
...
//                   onOpen={(evt) => openIntro(evt, ebookId)}
//                 />
//               </div>
//             </div>
//           );
...
export default function StudentBookshelf() {
  ...
  // ✅ SAME PATTERN AS COURSE / MOCK / QBANK
  const [enrolledMap, setEnrolledMap] = useState({});
  ...
  /* =========================================================
     ✅ FIX: AUTO OPEN INTRO WHEN COMING FROM MY ENROLLMENTS
     🔒 Waits for items to be loaded
     ❌ No logic / UX change
  ========================================================= */
 useEffect(() => {
  if (location.state?.openEbookId) {
    console.log(
      "📘 AUTO OPEN INTRO (route state):",
      location.state.openEbookId
    );

    setPendingEbookId(location.state.openEbookId);
    setShowIntro(true);
